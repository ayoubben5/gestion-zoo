...
<div class="container">
    <div class="row my-4">
        ...
        <div class="card">
        <div class="card-header text-center w-15"><h5>Departement Medical</h5></div>
...
<tbody>
    <?php foreach($med as $md): ?>
    <tr>
    <th scope="row"><?php echo $md['code_mnemotique']?></th>
    <td><?php echo $md['poste'] ?></td>
    <td>
    <form method="post" class="mr-1" action="salaire"> 
        <input type="hidden" name="code_mnemotique" value="<?php echo $md['code_mnemotique']; ?>">
